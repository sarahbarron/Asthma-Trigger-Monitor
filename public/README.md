...
*   The project should incorporate the different layers (sensor, processing node, gateway, application) of an IoT/connected device architecture.    
      ...
      *   I used a WIFI router as a gateway for my devices to cloud IoT platforms    
      *   I used HTTP for messaging    
      *   I used ARP for presence detection    
      *   I used ThingSpeaks MATLAB Analysis and Time Control to trigger IFTTT to send me an email each morning
...
I currently have two asthma and allergy sufferers living in my house and there are a number of triggers that effect their asthma including
...
I will send sensor values to Blynk and ThingSpeak IoT applications every 15 seconds to allow me to store, retrieve and display sensor values on line graphs, number displays and gauges. The purpose of this is to allow me to check the current sensor values either on my phone or on my laptop at any time. It will also allow me to view the sensor data over longer periods of time to compare or have an overall view over time of air quality within my home. I will also be able to complete MATLAB analysis on the sensor data if I needed too.
...
Every morning and night i will use the Blynk IoT application to send me a notification to remind me to give my two sons their asthma medication/Inhaler.
...
I will setup presence detection. I do not have access to my heating, humidifier or dehumidifier remotely. Therefore if I am in the house and the sensor values go out of range i will get a notification as I can turn on/off devices when I am at home. However if there is nobody detected at home I will not receive out of range notifications as I can not turn on/off devices remotely. I will set it up that the settings for this can be changed by the user, so if they want to receive notifications at all times weather they are at home or not they will receive a notification.

I also intend to create a website, that will show ThingSpeak graphs and current sensor readings and will communicate details of the project.
...
![Raspberry Pi 3B GIPO](./images/sensor-rpi-setup)
...
![ImportError: No module named smbus](./images/bme-setup1)
...
![5. Interfacing Options](./images/i2c-setup1)
- Select P5 I2C

![P5 I2C](./images/i2c-setup2)
- Select Yes

![yes](./images/i2c-setup3)
- Finish
...
![Create IFTTT Applet](./images/ifttt1)
- Click on This

![Click on This](./images/ifttt2)
- In the Search bar type in webhooks

![search for webhooks](./images/ifttt-setup3)
- Click on Receive a web request
- Enter an Event Name

![Enter an Event Name](./images/ifttt-setup5)
- Click on +That

![Click on That](./images/ifttt-setup6)
- In the search box enter email and select Email

![search for and select Email](./images/ifttt-setup7)
- Click on Send me an email

![Click on send me an email](./images/ifttt-setup8)
- Fill in the emails action fields (subject and body) as in the image below and click the create action button

![fill in the action fields](./images/ifttt-setup9)
- Review and finish.
- Copy the Make a POST or GET web request to URL

![copy the url](./images/ifttt-setup12)
...
![new channel called air-quality](./images/thingpeak-setup1)
...
![gauge settings](./images/thingspeak-gauge-settings) 
...
![Time Control Settings](./images/thingspeak-time-control) 
...
- Set up 3 gauges:
   - Click on the + symbol
     ...
     ![click the plus symbol](./images/blynk-plus)
    - From the menu select Gauge

      ![Select Gauge](./images/blynk-gauge1)
   ...
   ![setting of 3 gauges](./images/blynk-gauge2)
- Set up 1 Super chart
   - Click on the + symbol

   ![click on plus symbol](./images/blynk-plus)
   - Select SuperChart from the menu 
   
   ![Select SuperChart](./images/blynk-superchart-menu)
   - Setup the SuperChart the same as the settings in the diagram below
   
   ![SuperChart Settings](./images/blynk-superchart)
   - For each of the Datastreams (Temp, Humidity, IAQ) click on the small side menu option
   
   ![datastream settings](./images/blynk-superchart-sidemenu) 
   - For each one set them up like the diagram below
   
   ![Superchart settings](./images/blynk-superchart-settings)
...
![ThingSpeak Write API KEY](./images/thingspeak-api-key)
